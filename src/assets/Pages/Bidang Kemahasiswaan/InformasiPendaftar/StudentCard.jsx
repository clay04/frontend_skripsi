...
export const StudentCard = ({ faculty, name, id }) => {
  return (
    <article className="bg-light rounded-3 p-3 d-flex justify-content-between align-items-center mt-4 mx-2">
      ...
      <div className="d-flex align-items-center gap-4">
        <span className="text-secondary">GenBI</span>
        <button className="btn btn-light rounded-pill px-3 py-1 d-flex align-items-center gap-3">
          <Link to="/bidang/informasi-pendaftar/data-pendaftar"><span className="small">Detail</span></Link>
          <img
